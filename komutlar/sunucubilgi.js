...
exports.run = (client, message, params) => {
 ...
 let guild = message.guild;
   ...
   .addField('Üye Bilgisi : ['+message.guild.memberCount+']', `${client.emojis.get('674912273701273600')}${message.guild.members.filter(o => o.presence.status === 'offline').size} ${client.emojis.get('674912316130590780')}${message.guild.members.filter(o => o.presence.status === 'idle').size} ${client.emojis.get('674912239123431425')}${message.guild.members.filter(o => o.presence.status === 'online').size} ${client.emojis.get('674912195397812235')}${message.guild.members.filter(o => o.presence.status === 'dnd').size}`,false)
