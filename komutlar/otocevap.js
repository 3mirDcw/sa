...
exports.run = async (client, message, args) => {
  ...
  const Açık = new Discord.RichEmbed()
    .setColor('#960000')
    .setThumbnail(client.user.avatarURL)
    .addField('**Oto-Cevap Sistemi**', ':white_check_mark: Oto-Cevap Başarıyla Açıldı!')
    .setFooter(client.user.username, client.user.avatarURL)
    .setTimestamp()
  ...
  const Kapalı = new Discord.RichEmbed()
    .setColor('#960000')
    .setThumbnail(client.user.avatarURL)
    .addField('**Oto-Cevap Sistemi**', ':white_check_mark: Oto-Cevap Başarıyla Kapatıldı!')
    .setFooter(client.user.username, client.user.avatarURL)
    .setTimestamp()
